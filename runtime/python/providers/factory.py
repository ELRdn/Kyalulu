...
def get_provider(provider_type, **kwargs):
    types = {"mock": MockProvider, "ollama": OllamaProvider, "lm_studio": LMStudioProvider,
             ...
             "opencode_responses": ResponsesProvider, "le": LEProvider}
...
def get_provider_for_model(model_cfg):
    ...
    if provider["type"] in {"le", "responses", "openai_compatible", "openai-compatible", "openai", "openai_responses", "opencode_responses"}:
